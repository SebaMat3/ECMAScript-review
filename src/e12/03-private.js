/*  Since E12-2021 we're able to set methods as private, so that these cannot be accessed from outside the object;
simply add a # before the name of the declared method: #speak {...} */
// Declaring class
class Example {}
